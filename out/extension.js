    ...
    function cleanCode(regex) {
        ...
        if (editor.selection.isEmpty) {
            ...
            editor.edit(editBuilder => {
                const fullRange = new vscode.Range(editor.document.positionAt(0), editor.document.positionAt(docText.length));
            ...
            const newText = docText.replace(regex, '');
            editor.edit(editBuilder => {
                const fullRange = new vscode.Range(editor.document.positionAt(editor.document.offsetAt(editor.selection.start)), editor.document.positionAt(editor.document.offsetAt(editor.selection.end)));
                editBuilder.replace(fullRange, newText);
            });
        }
    }
